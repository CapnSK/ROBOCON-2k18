...
int tweak = 40;                            // Increase this to Decrease the overall speed of MANU
int slow = 5;                              // Used in fine tuning
int tune_speed = 10;                       // To tweak twist speeds
int tune_slow = 5;                         // To tweak twist speeds in fine tuning
...
void loop()
{
  ...
  if (Twist_left == 0)                                
  {
    Driver_1_3.write(L1 - tune_speed);
    Driver_2_4.write(L2 - tune_speed);
    Driver_1_3.write(H3 - tune_speed);
    Driver_2_4.write(H4 - tune_speed);
  }

  if (Twist_right == 0)
  {
    Driver_1_3.write(H1 - tune_speed);
    Driver_2_4.write(H2 - tune_speed);
    Driver_1_3.write(L3 - tune_speed);
    Driver_2_4.write(L4 - tune_speed);
  }

  if (Twist_left == 0 && (Hold == 0))
  {
    Driver_1_3.write(L1 - tune_slow);
    Driver_2_4.write(H2 - tune_slow);
    Driver_1_3.write(H3 - tune_slow);
    Driver_2_4.write(L4 - tune_slow);
  }

  if (Twist_right == 0 && (Hold == 0))
  {
    Driver_1_3.write(H1 - tune_slow);
    Driver_2_4.write(H2 - tune_slow);
    Driver_1_3.write(L3 - tune_slow);
    Driver_2_4.write(L4 - tune_slow);
  }
...
void slow_front()
{
  Driver_1_3.write(H1 - slow);
  Driver_2_4.write(H2 - slow);
  Driver_1_3.write(H3 - slow);
  Driver_2_4.write(H4 - slow);
}

void slow_reverse()
{
  Driver_1_3.write(L1 - slow);
  Driver_2_4.write(L2 - slow);
  Driver_1_3.write(L3 - slow);
  Driver_2_4.write(L4 - slow);
}
